...
const { challenge_builder } = require('../../record_builder/challenge_builder')

module.exports = function (db) {
  var module = {}

  querier.db = db
  querier.collection_name = 'challenges'
  ...
  module.addOne = async function (req, res) {
    ...
    captureJson = challenge_builder(capture_data)
 ...
 * ****************************/
  module.update = async function (req, res) {
    const captureJson = challenge_builder(req.body)
